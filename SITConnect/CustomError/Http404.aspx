<%@ Page Title="Page Error 404" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GenericError.aspx.cs" Inherits="SITConnect.CustomError.Http404" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        <div class="row bg-text bg-container-1" style="position: relative; top: 8vh; padding-bottom: 2px;">
            <span class="gallery-title trippin">Resource not found!</span>

            <h3 class="gallery-subtitle" style="text-align: left;">We can't seem to find the page you're looking for!</h3>
            <br />
            <p style="padding-left: 0px; font-family: 'JetBrains Mono', monospace;" class="navbar-brand"><b>Error Code:</b> <span class="trippin">404</span></p>
            <br />
            <br />
            <br />
