<%@ Page Title="Profile" Language="C#" MasterPageFile="~/Portal.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="SITConnect.Profile" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="profile-user" style="height: 740px;">
        ...
        <div class="user-extras">
            <a runat="server" onserverclick="logoutBtn_Click" class="btn btn-rect-icon" href="#">
